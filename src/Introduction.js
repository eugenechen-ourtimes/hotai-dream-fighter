          ...
          <div>
            {
              ...
              <div>
                ...
                <div style={{display: "flex",
                  ...
                  <img src={require('./introduction.png')}
                       alt="introduction"
                ...
                <div style={{display: "flex",
                  ...
                  <button style={{backgroundColor: 'transparent',
                                  position: 'absolute', zIndex: '2', top: '15.5%',
                ...
                <div style={{display: "flex",
                  ...
                  <img src={this.props.cityPhoto}
                       ...
                       style={{position: 'absolute', zIndex: '2', top: this.props.styleTop}}/>
                </div>

                <div style={{display: "flex",
                             justifyContent: "center",}}>
                  <button style={{backgroundColor: 'transparent',
                                  position: 'absolute', zIndex: '2', top: '53%',
                                  width: '220px', height:'300px',
                                  border:'none',
                                  fontSize: '13px',
                                  /*font:'fantasy'*/}}>
                    {this.props.cityIntroduction}
                  </button>
                </div>
